...
tape('sankey() has the expected defaults', test => {
  ...
  test.deepEqual(s.sourceId()({source: 'bar'}), 'bar')
  test.deepEqual(s.targetId()({target: 'baz'}), 'baz')
  test.deepEqual(s.sourcePort()({sourcePort: 'bar'}), 'bar')
  test.deepEqual(s.targetPort()({targetPort: 'baz'}), 'baz')
